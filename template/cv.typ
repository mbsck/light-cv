...
#let icons = (
  ...
  orcid: box()[#image("media/orcid.svg", width: 8.3pt)],
...
#header(
  ...
  socials: (
    ...
    (
      icon: icons.orcid,
      text: [0000-0002-6108-6931],
      link: "https://orcid.org/0000-0002-6108-6931",
    ),
  ),
)
...
#section(
  ...
  styles: styles,
  title: "Postdoc",
  company-or-university: "Max-Planck-Institute for Astronomy (PFE department)",
...
#section(
  ...
  location: "Heidelberg, DE",
  description: (
    [Thesis: #link("https://archiv.ub.uni-heidelberg.de/volltextserver/38020/")[the structure of the
        innermost regions of circumstellar discs with VLTI/MATISSE]],
  ),
)
#entry(
  styles: styles,
...
#link(
  "https://scixplorer.org/search?p=1&q=author%3A%22scheuck%22&sort=score+desc&sort=date+desc&d=general",
)[NASA-ADS/Scixplorer]
#list(
  spacing: 1em,
  [#link("https://scixplorer.org/abs/2026A%26A...708A.380S")[The asymmetric structure
      of the inner disc around HD 142527 A with VLTI/MATISSE.] *M. B. Scheuck*, et al.,
    _A&A_, Volume 708, id. A380, 22 pp. (2026).],
  [#link("https://scixplorer.org/abs/2026A%26A...708A.256V")[The complex inner disk of
      the Herbig Ae star HD 100453 with VLTI/MATISSE]. L.N.A van Haastere, J. Varga,
    M. Hogerheijde, C. Dominik, *M. Scheuck*, et al., _A&A_, Volume 708, id. A256, 17 pp. (2026).],
...
#skill(
  ...
  skills: ("Python", "Julia", "Rust", LaTeX, "Typst", "Bash", "Zsh", "Fish"),
)
#skill(
  styles: styles,
  category: "Languages",
  skills: ("German (native)", "English (C2)", "Japanese (B2)", "Spanish (A2)", "French (A1)"),
)
